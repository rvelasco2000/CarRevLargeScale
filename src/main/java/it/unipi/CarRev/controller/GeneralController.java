...
public class GeneralController {
    ...
    public GeneralController(ShowReviewOfAUserServiceImplementation showReviewOfAUserServiceImplementation){
        this.showReviewOfAUserServiceImplementation=showReviewOfAUserServiceImplementation;
    }
    @GetMapping("/userRev")
    private ResponseEntity<?> getUserReviews(@NotNull @RequestParam String username,@NotNull @RequestParam Integer numPage){
        try{
